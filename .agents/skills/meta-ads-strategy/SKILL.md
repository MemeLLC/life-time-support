...
description: Meta（Facebook/Instagram）広告の運用戦略を立案し、キャンペーン目的・広告フォーマット・配置面の選定、キャンペーン構造の設計、クリエイティブ・コピーの仕様書作成までを一貫して支援する。ユーザーがMeta広告・Facebook広告・Instagram広告に言及した場合に使用する。
---
